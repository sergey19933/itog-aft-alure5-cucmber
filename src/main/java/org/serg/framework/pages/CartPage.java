...
public class CartPage extends BasePage {
    ...
    public CartPage checkingPage() {
        Assertions.assertEquals("Корзина", checkingThePage.getText(), "Не та страница");
        return this;
    }
...
//        System.out.println(pageManager.getListProduct().getProductInfoListPrice());
        ...
        Assertions.assertTrue(collectionsEquals, "Не совпадает список товаров");

        return this;
    }


    //проверка что "Ваша корзина  8 товаров"
    public CartPage checkingCartAllProductPage() {
        ...
        Assertions.assertEquals("Ваша корзина  "+pageManager.getListProduct().getProductInfoList().size()
                + " тов", nameCartAndCountProduct.substring(0, 19), "Не совпадет");
        return this;
    }
    ...
    public CartPage removeAllProducts() {
        ...
        try {
            Assertions.assertEquals("Корзина пуста", checkCartRemove.getText(), "Корзина не пуста");
